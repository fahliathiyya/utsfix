            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Form Edit Tipe Motor</h1>
                        <div class="card mb-4">
                                ...
                                <div class="container">
                                    ...
                                    <input type="hidden" name="idedit" value="<?=$result['id']?>" >
                                        <div class="form-group">
                                            <label for="nama_merk" class="form-label">Nama Tipe Motor</label>
                                            <input id="nama_merk" name="nama_merk"  value="<?=$result['nama_merk']?>" type="text" class="form-control" required>
                                        </div>
